<?php
	...
	// https://graph.facebook.com/v11.0/{ig-comment-id}?access_token=EAAEpATmnLkkBABlaZBIiILT4fAeU7FoiGMe7efKW28iadgbGRszWex5prGP3AiiiyljP0HeCxSHuTHQATBe8850serGJQGg6wF8QHd1yhZBhm9x4mlqCWx1U4JdhF0laJcuVJxZBr0F2KOwFrENvcihGWmZBmqcBfzjy95SMtQZDZD
	// postCommentEndpoint formats
	$deleteCommentEndpointFormat = ENDPOINT_BASE . '{ig-comment-id}?';
	$deleteCommentEndpoint = ENDPOINT_BASE . $data['commentID'] ;
	...
	$deleteCommentEndpoint .= '?' . http_build_query( $igParams );

	// setup curl
	$ch = curl_init();
	curl_setopt( $ch, CURLOPT_URL, $deleteCommentEndpoint );
